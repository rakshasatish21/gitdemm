...
public class Shru_Ass5_pendants_15k {
	static 
	{
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//span[text()='Between 15k-20k' and @data-p='pendants-10k15k,m']")).click();
		Thread.sleep(1000);
		int n=0;
		...
		if(n>10000 && n<15000)
		{
			System.out.println("All products are between 10k and 15k");
		}
		else
		{
			System.out.println("All products are not between 10k and 15k");
		}
	}
}
